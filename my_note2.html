...
<div class="cw1000">
	<div class="public_box pd30">
		<div class="public_tag">
			<ul>
				<li><a href="my_note.html">已发表游记</a></li>
				<li><a class="cur" href="my_note2.html">我的草稿</a></li>
				<div class="clear"></div>
			</ul>
		</div>
		<!-----------------游记列表---------------->
		<div class="note_list">
			<ul>
				<li class="pd_r150">
					...
					<div class="operation">
						<a href="#"><i class="express_ico"></i>发表</a>
						<a href="#"><i class="edit_ico"></i>修改</a>
						<a href="#"><i class="del_ico"></i>删除</a>
					</div>
				</li>
				<li class="pd_r150">
					<div class="pic"><img src="images/y1.jpg"/></div>
