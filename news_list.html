    ...
    <div class="cw1200">
		<div class="w810 fl">
			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					<ul>
						<li><span>新闻类别：</span><a class="cur" href="#">全部</a><a href="#">热点资讯</a><a href="#">活动资讯</a><a href="#">孟津文化</a><a href="#">孟津美食</a><a href="#">孟津生活</a><a href="#">孟津特产</a><div class="clear"></div></li>
					</ul>
				</div>
				<!------------------新闻列表-------------------->
				<div id="news_list">
					<ul>
						<li>
							...
							<div class="pic"><a href="article.html"><img class="scale-effect" src="images/y1.jpg"/></a></div>
							<div class="con">
								<h3><a href="article.html">黔阳古城慢时光旅游的6大看点</a></h3>
								<p>首先要去的就是芙蓉楼，据说此处是唐朝诗人王昌龄游玩会客之所。在清朝时期，又是黔阳本地才子佳人聚集之地<a href="article.html">详细信息</a></p>
							</div>
							<div class="share">
